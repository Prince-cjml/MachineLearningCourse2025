...
% 红色椭圆圈选
\draw[red, line width=1.2pt, rotate=15]
      (0.5,2) ellipse [x radius=0.5cm, y radius=0.55cm];


% ==== 中间的红色波浪分隔线 ====
% 用平滑样条画一条波浪线
\draw[red, line width=1.4pt]
  (-3.2,0.8) .. controls (-2.4,0.5) and (-1.6,1.1) ..
  (-0.8,0.8) .. controls (0.0,0.5) and (0.8,1.1) ..
  (1.6,0.8) .. controls (2.4,0.5) and (3.2,1.1) .. (4.0,0.8);
